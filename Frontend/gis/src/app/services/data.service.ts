...
export class DataService {
  ...
  /**
   * Retrieves the bardichte from the given api endpoint.
   */
  ...
  /**
   * Retrieves the normalized bardichte from the given api endpoint.
   */
  getBardichteNorm(): Observable<FeatureCollection> {
    const url = 'http://localhost:5000/api/data/bardichteNorm';
    return this.http.post<FeatureCollection>(url, null, httpOptions);
  }
